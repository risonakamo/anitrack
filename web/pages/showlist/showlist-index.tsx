...
import {getCurrentShows,getAllExtraShowInfos,updateExtraShowInfoDB} from "lib/database/database";
import {groupByDay} from "lib/database/database-helpers";
...
function main()
{
  createRoot(document.querySelector("main")!).render(<ShowlistMain/>);
}
