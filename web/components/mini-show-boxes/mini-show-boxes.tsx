...
import {openNyaa} from "lib/nyaa-helpers";
...
export default function MiniShowBoxes(props:MiniShowBoxesProps):JSX.Element
{
  ...
  return <div className={clsx("mini-show-boxes",props.day,{today:props.today})}>
    ...
    <div className="boxes">
      <p className={clsx("no-shows",{showing:!props.shows.length})}>no shows</p>
      {shows}
    </div>
  </div>;
}